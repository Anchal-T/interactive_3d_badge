            ...
            <group position={[0, 4, 0]}>
                ...
                <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
                    ...
                    <group
                        ...
                        onPointerDown={(e) => (e.target.setPointerCapture(e.pointerId), drag(new THREE.Vector3().copy(e.point).sub(vec.copy(card.current.translation()))))}>                        <mesh geometry={nodes.Plane.geometry} position={[-0.002, 0.674, -0.011]} rotation={[-2.405, 1.566, -2.309]} scale={0.357}>
                            <meshPhysicalMaterial 
                                map={texture} 
                                map-rotation={Math.PI / 2 + Math.PI / 2 
                                    + Math.PI / 2
                                }
                                map-anisotropy={16} 
                                clearcoat={1} 
